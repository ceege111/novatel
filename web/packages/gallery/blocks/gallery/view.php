...
<script type="text/javascript">
   ...
   //      });
       $('#ccm-gallery-<?php  echo $bID?>').gridSlider({cols: 3, rows: 4,align:'center',width:'900px',autoplay_enable:true,autoplay_interval:6,scroll_axis:'x',loop:true,ctrl_arrows:false,ctrl_pag:true,ctrl_always_visible:true});
    });
