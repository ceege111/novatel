...
foreach($searchFieldAttributes as $ak) {
	if( $ak->getAttributeKeyHandle()=='job_id' )  continue; 
...
<?php  $form = Loader::helper('form'); ?>
	...
	<form method="get" id="ccm-<?php echo $searchInstance?>-advanced-search" action="<?php echo View::url('/tools/packages/tony_jobs_board/listing_search_results/')?>">
	...
	?>
		...
		<div id="ccm-search-advanced-fields-inner">
			...
			<div class="ccm-search-field">
				...
				<tr>
					<td width="100%">
					<strong><?php echo $form->label('job_id', t('Job ID'))?></strong>
					<?php echo $form->text('job_id', $searchRequest['job_id'], array('style' => 'width:200px')); ?>
					</td>
				</tr>
				</table>
			</div>        
			...
			<div class="ccm-search-field">
				...
				<tr>
					...
					<?php  } */ ?>
					<strong><?php echo $form->label('keywords', t('Keyword Search'))?></strong>
			...
			<div class="ccm-search-field">
				...
				<tr>
					<td style="white-space: nowrap" align="right"><div style="padding-right:5px"><?php echo t('Results Per Page')?></div></td>
					<td width="100%">
			...
			<div id="ccm-search-field-base">				
				<table border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                    	<td class="ccm-selected-field-content" colspan="2">
